    ...
    setProducts([
      {
        ...
        description:
          "Personal AI tutor that adapts to your learning style. Features smart flashcards, personalized quizzes, and real-time concept explanations using advanced language models.",
        price: 49,
        originalPrice: 99,
        discount: 50,
        seller: "AIEdu Labs",
      ...
      },
      {
        ...
        description:
          "Production-ready ML project templates with TensorFlow and PyTorch implementations. Includes data preprocessing, model training, and deployment pipelines.",
        price: 79,
        originalPrice: 129,
        discount: 40,
      ...
      {
        id: "prod-3",
        title: "GPT-Powered Research Assistant",
        description:
          "AI research companion that helps with literature review, paper summarization, and citation management. Built with the latest large language models.",
        price: 39,
        originalPrice: 79,
        discount: 50,
        seller: "Research AI",
